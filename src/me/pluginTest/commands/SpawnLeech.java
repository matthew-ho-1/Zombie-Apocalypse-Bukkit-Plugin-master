...
public class SpawnLeech implements CommandExecutor {
    private Main plugin;

    public SpawnLeech(Main plugin) {
        this.plugin = plugin;
        plugin.getCommand("summonleech").setExecutor(this);
    }
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        World w = p.getWorld();
        p.getServer().broadcastMessage("Leech spawned");
